...
export default class ProhibitionInformationCard extends Vue {   
	...
	@Prop({required: true})
    prohibitionInfo!: twentyFourHourFormDataInfoType;
	
	@Prop({required: true})
	prohibitionState!: twentyFourHourFormStatesInfoType;
    ...
    prohibitionTypeOptions = [
        {text: 'Alcohol 215(2)', value: 'Alcohol'},
        {text: 'Drugs 215(3)', value: 'Drugs'}
    ];
