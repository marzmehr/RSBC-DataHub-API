...
<!-- <ROW1> -->
                ...
                <tr style="height:0.5rem;  line-height:0.5rem; border-top:0px solid;">
                    <td class="side-name" style="font-size:8pt; transform:rotate(-90deg) translate(-42px,-5px)" colspan="5"><b>DRIVER</b></td>                    
                    <td class="" style="transform:translate(-8px,0px)" colspan="59">SURNAME, GIVEN NAME(S)</td> 
                    <td class="" style="" colspan="1" />
                    <td class="" style="" colspan="16">BIRTH DATE (YYYY/MM/DD)</td>
                    <td class="" style="" colspan="1" />
                    <td class="" style="" colspan="17">GENDER</td>
                    <td class="" style="" colspan="1" />                                                          
                </tr>
                ...
                <tr style="height:0.5rem;  line-height:0.5rem; border-top:0px solid;">                    
                    <td class="" style="" colspan="4" />
                    <td class="" style="" colspan="48">DRIVER’S LICENCE NUMBER</td> 
                    <td class="" style="" colspan="1" />
                    <td class="" style="" colspan="13">PROVINCE/STATE</td>
                    <td class="" style="" colspan="1" />
                    <td class="" style="" colspan="7">CLASS</td>
                    <td class="" style="" colspan="1" />
                    <td class="" style="" colspan="12">EXPIRY YEAR (YYYY)</td>
...
.side-name{
    transform:rotate(-90deg) translate(-40px,-5px) !important;
}
