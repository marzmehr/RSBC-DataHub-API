<template>
    <div v-if="dataReady">
        <div class="lineheight0-25 text-center" style="font-size:11pt; margin:0.75rem 0 0 0;   line-height:1rem;"><b>Officer’s Report</b> (Continued)</div>
...
<!-- <ROW2> -->
                ...
                <tr style="height:0.5rem; line-height:1rem;" ></tr>
