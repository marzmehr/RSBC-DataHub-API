<template>
    <div v-if="dataReady">
        <div class="row lineheight0-25" style="font-size:11pt; margin:0rem 0 0 0;   line-height:1rem;"><b>NOTICE OF 24-HOUR PROHIBITION</b></div>
        <div class="row lineheight0-25" style="font-size:11pt; margin:0rem 0 0 0;   line-height:1rem;"><b>AND REPORT TO ICBC</b></div>
        <div class="row lineheight0-25 margin-top-0" style="margin:0.5rem 0 0 0; line-height:1rem;">
            <div class="answer text-left" style="font-size:11pt; width:67%;">VZ-100088 </div>
